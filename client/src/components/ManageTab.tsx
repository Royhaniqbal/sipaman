  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      await axios.put(
        ...
        { username, email, unitKerja }, // Pastikan backend Anda punya endpoint ini
        { headers: { Authorization: `Bearer ${token}` } }
      );
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <button 
              ...
              disabled={!isEditing}
              className={`w-full py-3 rounded-xl font-semibold transition shadow-md active:scale-95 ${
            ...
            <button 
                ...
                className={`w-full py-2.5 text-sm rounded-xl font-semibold transition shadow-md active:scale-95 ${
                  isEditing 
                    ...
                    : "bg-blue-500 text-white hover:bg-blue-700" // Saat mode biasa: tombol Edit jadi BIRU
                }`}
              >
